...
--
-- Name: electricity_ef; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.electricity_ef (
...
ALTER TABLE public.electricity_ef OWNER TO postgres;
...
--
-- Data for Name: electricity_ef; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.electricity_ef (id, sector, state, sc2, sc3, unit) FROM stdin;
...
SF-1	Fuel	Soild Fuel	Bituminous coal	27	t	90	0.04	0.2	90.24	3
SF-2	Fuel	Soild Fuel	Sub-bituminous coal	21	t	90	0.04	0.2	90.24	2.5
SF-3	Fuel	Soild Fuel	Anthracite	29	t	90	0.04	0.2	90.24	\N
SF-4	Fuel	Soild Fuel	Brown coal (lignite)	10.2	t	93.5	0.02	0.3	93.82	0.4
SF-5	Fuel	Soild Fuel	Coking coal	30	t	91.8	0.03	0.2	92.03	6.4
SF-6	Fuel	Soild Fuel	Coal briquettes	22.1	t	95	0.08	0.3	95.38	\N
SF-7	Fuel	Soild Fuel	Coal coke	27	t	107	0.03	0.2	107.23	\N
SF-8	Fuel	Soild Fuel	Coal tar	37.5	t	81.8	0.03	0.2	82.03	\N
SF-9	Fuel	Soild Fuel	Solid fossil fuels other than those mentioned in the items above	22.1	t	95	0.08	0.2	95.28	\N
SF-10	Fuel	Soild Fuel	Industrial materials that are derived from fossil fuels, if recycled and combusted to produce heat or electricity	26.3	t	81.6	0.03	0.2	81.83	\N
SF-11	Fuel	Soild Fuel	Passenger car tyres, if recycled and combusted to produce heat or electricity	32	t	62.8	0.03	0.2	63.03	\N
SF-12	Fuel	Soild Fuel	Truck and off-road tyres, if recycled and combusted to produce heat or electricity	27.1	t	55.9	0.03	0.2	56.13	\N
SF-13	Fuel	Soild Fuel	Nonâ€‘biomass municipal materials, if combusted to produce heat or electricity	10.5	t	87.1	0.8	1	88.9	\N
SF-14	Fuel	Soild Fuel	Dry wood	16.2	t	0	0.1	1.1	1.2	\N
SF-15	Fuel	Soild Fuel	Green and air dried wood	10.4	t	0	0.1	1.1	1.2	\N
SF-16	Fuel	Soild Fuel	Sulphite lyes	12.4	t	0	0.08	0.5	0.58	\N
SF-17	Fuel	Soild Fuel	Bagasse	9.6	t	0	0.3	1.1	1.4	\N
SF-18	Fuel	Soild Fuel	Biomass, municipal and industrial materials, if combusted to produce heat or electricity	12.2	t	0	0.8	1	1.8	\N
SF-19	Fuel	Soild Fuel	Charcoal	31.1	t	0	5.3	1	6.3	\N
SF-20	Fuel	Soild Fuel	Primary solid biomass fuels other than those mentioned in the items above	12.2	t	0	0.8	1	1.8	\N
...
LF-1	Fuel	Liuquid Fuel	Petroleum based oils (other than petroleum based oil used as fuel), e.g. lubricants	38.8	kL	13.9	0	0	13.9	18
LF-2	Fuel	Liuquid Fuel	Petroleum based greases	38.8	kL	3.5	0	0	3.5	18
LF-3	Fuel	Liuquid Fuel	Automotive gasoline/petrol (other than for use as fuel in an aircraft)	34.2	kL	67.4	0.2	0.2	67.8	17.2
LF-4	Fuel	Liuquid Fuel	Aviation gasoline	33.1	kL	67	0.2	0.2	67.4	18
LF-5	Fuel	Liuquid Fuel	Kerosene (other than for use as fuel in an aircraft)	37.5	kL	68.9	0.01	0.2	69.11	18
LF-6	Fuel	Liuquid Fuel	Aviation turbine fuel/kerosene	36.8	kL	69.6	0.02	0.2	69.82	18
LF-7	Fuel	Liuquid Fuel	Heating oil	37.3	kL	69.5	0.03	0.2	69.73	18
LF-8	Fuel	Liuquid Fuel	Diesel oil	38.6	kL	69.9	0.1	0.2	70.2	17.3
LF-9	Fuel	Liuquid Fuel	Fuel oil	39.7	kL	73.6	0.04	0.2	73.84	18
LF-10	Fuel	Liuquid Fuel	Liquefied aromatic hydrocarbons	34.4	kL	69.7	0.03	0.2	69.93	18
LF-11	Fuel	Liuquid Fuel	Solvents: mineral turpentine or white spirits	34.4	kL	69.7	0.03	0.2	69.93	18
LF-12	Fuel	Liuquid Fuel	Liquefied petroleum gas (LPG)	25.7	kL	60.2	0.2	0.2	60.6	20.2
LF-13	Fuel	Liuquid Fuel	Naphtha	31.4	kL	69.8	0.01	0.01	69.82	18
LF-14	Fuel	Liuquid Fuel	Petroleum based products other than mentioned in the items above	34.4	kL	69.8	0.02	0.1	69.92	18
LF-15	Fuel	Liuquid Fuel	Biodiesel	34.6	kL	0	0.08	0.2	0.28	\N
LF-16	Fuel	Liuquid Fuel	Ethanol for use as a fuel in an internal combustion engine	23.4	kL	0	0.08	0.2	0.28	\N
LF-17	Fuel	Liuquid Fuel	Biofuels other than those mentioned in the items above	23.4	kL	0	0.08	0.2	0.28	\N
LF-18	Fuel	Liuquid Fuel	Crude oil including crude oil condensates	45.3	t	69.6	0.08	0.2	69.88	\N
LF-19	Fuel	Liuquid Fuel	Other natural gas liquids	46.5	t	61	0.08	0.2	61.28	\N
LF-20	Fuel	Liuquid Fuel	Petroleum coke	34.2	t	92.6	0.08	0.2	92.88	18
LF-21	Fuel	Liuquid Fuel	Refinery gas and liquids	42.9	t	54.7	0.03	0.03	54.76	18
LF-22	Fuel	Liuquid Fuel	Refinery coke	34.2	t	92.6	0.08	0.2	92.88	18
\.
...
--
-- Name: electricity_ef electricity_ef_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.electricity_ef
